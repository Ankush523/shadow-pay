  ...
  return (
    <div className='flex flex-col justify-center'>
        ...
        <div className='flex flex-col justify-around px-[40%]'>
          <Link href='/setup' className='flex flex-col text-center border border-white p-5 mb-10 bg-slate-950'>
              <label className='text-2xl mb-2 text-blue-600 font-bold'>Account Setup</label>
              <label>Setup your account</label>
          </Link>
          <Link href='/send' className='flex flex-col text-center border border-white p-5 mb-10 bg-slate-950'>
